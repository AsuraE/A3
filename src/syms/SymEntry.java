...
import tree.DeclNode.ProcedureNode;
...
public abstract class SymEntry {
    ...
    private SymEntry( String id, Position p, Type t, boolean r ) {
    ...
    public static class ConstantEntry extends SymEntry {
        ...
        ConstantEntry(String id, Position p, Type t, int val) {
            super( id, p, t, true );
            value = val;
            status = Status.Resolved;
        }
        /** Constructor when only an abstract syntax tree is available. */
        ConstantEntry(String id, Position p, Type t, ConstExp val) {
            super( id, p, t, false );
    ...
    public static class TypeEntry extends SymEntry {
        ...
        TypeEntry( String id, Position p, Type t ) {
            super( id, p, t, false );
        }
        @Override
        public String toString() {
    ...
    public static class VarEntry extends SymEntry {
        ...
        public VarEntry(String id, Position p, ReferenceType t ) {
            super( id, p, t, false );
        }
    ...
    public static class ParamEntry extends VarEntry {
        ...
        public ParamEntry(String id, Position p, ReferenceType type){
            super( id, p, type );
        }
    ...
    /** Symbol table entry for a reference parameter.
     * It extends ParamEntry and hence VarEntry.
     */
    public static class RefParamEntry extends ParamEntry {
        
        public RefParamEntry( String id, Position p, ReferenceType type ) {
            super( id, p, type );
        }
        @Override
        public int getSpace() {
    ...
    public static class ProcedureEntry extends SymEntry {
        ...
        public ProcedureEntry( String id, Position p, 
