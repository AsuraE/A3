...
public abstract class Type 
{
        ...
        public Type resolveType( Position pos ) {
            if( !resolved ) {
                ...
                if( !upperExp.getType().equals(lowerExp.getType())) {
                    errors.error( "Types of bounds of subrange must match", pos );
                    baseType = ERROR_TYPE;
                }
                resolved = true;
            }
    ...
    public static class ProcedureType extends Type {
        /** List of parameters in order of declaration. */
        ...
        public ProcedureType() {
            ...
            /** Initially empty list of parameters */
        ...
        public boolean equals( Type other ) {
            if( other instanceof ProcedureType ) {
                // TODO check parameter types match
                return true;
            } else {
                return false;
            }
    ...
    public static class IdRefType extends Type {
        ...
        public IdRefType( String id, Scope scope, Position pos ) {
            super( 0, false, id );
            this.id = id;
            this.scope = scope;
            this.pos = pos;
        ...
        public Type resolveType( Position usePos ) {
            ...
            case Unresolved:
                ...
                if( entry != null ) {
                    ...
                    errors.error( "undefined type: " + id, pos );
                }
