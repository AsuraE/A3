...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon May 09 23:25:06 AEST 2016
  */
public class CUPParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\002\022\003\000\002\022\005\000\002\021\005\000\002" +
    "\021\006\000\002\027\005\000\002\025\003\000\002\025" +
    "\005\000\002\026\006\000\002\026\010\000\002\026\003" +
    "\000\002\026\004\000\002\026\004\000\002\026\005\000" +
    "\002\026\006\000\002\026\007\000\002\026\003\000\002" +
    "\024\003\000\002\024\005\000\002\023\003\000\002\041" +
  ...
  protected static final short[][] _action_table = 
    ...
    "\006\005\uffcc\024\uffcc\001\002\000\006\005\uffce\024\uffce" +
    ...
    "\uffd0\033\uffd0\034\uffd0\001\002\000\006\005\uffcd\024\uffcd" +
    ...
    "\000\004\015\uffdf\001\002\000\010\005\177\040\200\047" +
    "\203\001\002\000\004\015\uffe0\001\002\000\004\047\211" +
    "\001\002\000\006\005\uffde\024\uffde\001\002\000\006\005" +
    "\207\024\206\001\002\000\004\007\204\001\002\000\004" +
    "\047\151\001\002\000\006\005\uffdc\024\uffdc\001\002\000" +
    "\006\040\200\047\203\001\002\000\004\015\uffe1\001\002" +
    "\000\006\005\uffdd\024\uffdd\001\002\000\004\007\212\001" +
    "\002\000\004\047\151\001\002\000\006\005\uffdb\024\uffdb" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$CUPParser$act_num)
		...
		ExpNode c = (ExpNode)((java_cup.runtime.Symbol) CUP$CUPParser$stack.peek()).value;
			...
			RESULT = new ExpNode.ParamNode( new Position( cleft ), c );
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 52: // ActualParamList ::= ActualParamList COMMA ActualParam 
            {
              ArrayList<ExpNode.ParamNode> RESULT =null;
		...
		ArrayList<ExpNode.ParamNode> apl = (ArrayList<ExpNode.ParamNode>)((java_cup.runtime.Symbol) CUP$CUPParser$stack.elementAt(CUP$CUPParser$top-2)).value;
		...
		ExpNode.ParamNode ap = (ExpNode.ParamNode)((java_cup.runtime.Symbol) CUP$CUPParser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 51: // ActualParamList ::= ActualParam 
            {
              ArrayList<ExpNode.ParamNode> RESULT =null;
		int apleft = ((java_cup.runtime.Symbol)CUP$CUPParser$stack.peek()).left;
		int apright = ((java_cup.runtime.Symbol)CUP$CUPParser$stack.peek()).right;
		ExpNode.ParamNode ap = (ExpNode.ParamNode)((java_cup.runtime.Symbol) CUP$CUPParser$stack.peek()).value;
			...
			RESULT = new ArrayList<ExpNode.ParamNode>();
			RESULT.add( ap );
		...
		ArrayList<ExpNode.ParamNode> pl = (ArrayList<ExpNode.ParamNode>)((java_cup.runtime.Symbol) CUP$CUPParser$stack.elementAt(CUP$CUPParser$top-1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 48: // Statement ::= KW_CALL IDENTIFIER LPAREN RPAREN 
            {
              StatementNode RESULT =null;
		...
		StatementNode.ListNode sl = (StatementNode.ListNode)((java_cup.runtime.Symbol) CUP$CUPParser$stack.elementAt(CUP$CUPParser$top-1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 38: // FormalParam ::= KW_REF IDENTIFIER COLON TypeIdentifier 
            {
		...
		Type ti = (Type)((java_cup.runtime.Symbol) CUP$CUPParser$stack.peek()).value;
			...
			RESULT = new SymEntry.RefParamEntry( id, new Position( idleft ), new Type.ReferenceType( ti.resolveType( new Position( idleft ) ) ) );
		...
		Type ti = (Type)((java_cup.runtime.Symbol) CUP$CUPParser$stack.peek()).value;
			...
			RESULT = new SymEntry.ParamEntry( id, new Position( idleft ), new Type.ReferenceType( ti.resolveType( new Position( idleft ) ) ) );
          ...
          case 36: // FormalParamList ::= FormalParamList COMMA FormalParam 
            {
              ArrayList<SymEntry.ParamEntry> RESULT =null;
		...
		ArrayList<SymEntry.ParamEntry> fpl = (ArrayList<SymEntry.ParamEntry>)((java_cup.runtime.Symbol) CUP$CUPParser$stack.elementAt(CUP$CUPParser$top-2)).value;
		...
		int plleft = ((java_cup.runtime.Symbol)CUP$CUPParser$stack.elementAt(CUP$CUPParser$top-1)).left;
		int plright = ((java_cup.runtime.Symbol)CUP$CUPParser$stack.elementAt(CUP$CUPParser$top-1)).right;
		ArrayList<SymEntry.ParamEntry> pl = (ArrayList<SymEntry.ParamEntry>)((java_cup.runtime.Symbol) CUP$CUPParser$stack.elementAt(CUP$CUPParser$top-1)).value;
